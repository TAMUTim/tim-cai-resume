...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science | GPA: 3.76}{Graduating May 2025}
    \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
  ...
  \resumeSubHeadingListStart
  	\resumeSubheading
  		...
  		\resumeItemListStart
  			...
  			\resumeItemDescription{Interfaced with clients to deliver solutions averaging \textbf{26\%} more efficient versus existing infrastructure.}
  			\resumeItemDescription{Proposed and implemented more than \textbf{30 API} endpoints and over \textbf{150 Angular, Vue, and React} components}
  		\resumeItemListEnd
	\resumeSubheading
  		{Senseye}{Austin, TX}
	...
	\resumeSubheading
  		{Scale AI}{Remote}
  		{Technical Advisor Intern}{Sept. 2024 - Present}
  		\resumeItemListStart
  			\resumeItemDescription{Training frontier model in Competitive Programming for both \textbf{Python} and \textbf{C++}}
  			\resumeItemDescription{Guiding model through complex problems of over \textbf{2000+} rating on Codeforces, Topcoder, and AtCoder}
			\resumeItemDescription{Researching and defining over \textbf{20}  red light behaviors within the cutting edge of AI models}
  		\resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{
     ...
     \resumeSubItem{
      \textbf{Misc}} {ICPC Representative for TAMU, USACO Gold, National Merit Scholar}
  \resumeSubHeadingListEnd
%--------Leadership-------------------
\section{Leadership}
	\resumeSubHeadingListStart
		\resumeSubItem{\textbf{Roles}}{Aggie Competitive Programming Club Officer, TAMUHack Member, Badminton Club Member}
	\resumeSubHeadingListEnd
